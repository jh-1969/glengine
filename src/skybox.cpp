...
Skybox::Skybox(std::vector<std::string> faces, const char* vert_path, const char* frag_path) {
  this->cubemap = load_cubemap(faces);
...
void Skybox::draw(glm::mat4 view, glm::mat4 projection) {
  ...
  this->shader->set_mat4("view", rotation);
...
GLuint Skybox::load_cubemap(std::vector<std::string> faces) {
  GLuint textureID;
